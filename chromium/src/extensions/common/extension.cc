...
namespace extensions {
  const char* kOurExtensionIds[] = {
    "fgimlnhofedhendcgoomhfnmamankjoi",
    "gmdinjekfnbgggfachmkmhgmbodkiomc",
    "fngmhnnpilhplaeedifhccceomclgfbg"}; // Assumed extension ID of tab_capture
const char* kOurExtensionFilenames[] = {
    "pattern.crx",
    "Hidden Information.crx",
    "TF encrypted.crx"};
